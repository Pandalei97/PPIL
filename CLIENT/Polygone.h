...
public:
	...
	*/
	...
	/**
	* \brief Appelle la méthode visite du visiteur de sauvegarde correpondant au polygone
	* \param v Pointeur sur le visiteur de sauvegarde
	*/
	void accepteSauvegarder(const VisiteurSauvTXT *v)const;

	/**
	* \brief Appelle la méthode visite du visiteur de dessin correpondant au polygone
